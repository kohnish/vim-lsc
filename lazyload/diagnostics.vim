...
# Seemingly useless functions and calls are commented out for now
...
#         return
#     endif
#     var new_list = {'items': AllDiagnostics(), 'idx': -1}
#     if len(new_list.items) > 0 && current.idx > 0 && len(current.items) >= current.idx
...
#         UpdateWindowState(window_id, diagnostics)
#     endfor
# enddef
